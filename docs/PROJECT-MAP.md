...
| | | | |
|---|---|---|---|
| **117** models | **161** services | **59** admin resources | **9** portal resources |
| **54** API controllers | **19** dashboard widgets | **52** console commands | **6** queued jobs |
| **37** notifications | **259** migrations | **37** module docs | **856** test files |
...
| **Tests** | 856 files — 144 scenario, 456 regression. |
