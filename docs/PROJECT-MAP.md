...
| **52** API controllers | **19** dashboard widgets | **49** console commands | **6** queued jobs |
| **35** notifications | **237** migrations | **37** module docs | **810** test files |
...
| **Tests** | 810 files — 136 scenario, 419 regression. |
