...
| | | | |
|---|---|---|---|
| **107** models | **159** services | **53** admin resources | **9** portal resources |
| **52** API controllers | **19** dashboard widgets | **51** console commands | **6** queued jobs |
| **36** notifications | **243** migrations | **37** module docs | **825** test files |

### Coverage — what the gates actually enforce

| Dimension | State |
|---|---|
| **Property isolation** | 107 models classified — 81 property-owned, 25 shared, 1 self. Gated by `PropertyIsolationConformanceTest`. |
