...
| | | | |
|---|---|---|---|
| **83** models | **126** services | **42** admin resources | **6** portal resources |
| **39** API controllers | **17** dashboard widgets | **39** console commands | **6** queued jobs |
| **29** notifications | **173** migrations | **34** module docs | **532** test files |
...
| **Tests** | 532 files — 88 scenario, 225 regression. |
