...
| **52** API controllers | **19** dashboard widgets | **50** console commands | **6** queued jobs |
| **35** notifications | **237** migrations | **37** module docs | **815** test files |
...
| **Tests** | 815 files — 137 scenario, 423 regression. |
