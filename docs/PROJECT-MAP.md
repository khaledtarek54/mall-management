...
| | | | |
|---|---|---|---|
| **105** models | **156** services | **52** admin resources | **9** portal resources |
| **52** API controllers | **19** dashboard widgets | **47** console commands | **6** queued jobs |
| **35** notifications | **237** migrations | **37** module docs | **780** test files |

### Coverage — what the gates actually enforce

| Dimension | State |
|---|---|
| **Property isolation** | 105 models classified — 80 property-owned, 24 shared, 1 self. Gated by `PropertyIsolationConformanceTest`. |
...
| **Tests** | 780 files — 129 scenario, 397 regression. |
