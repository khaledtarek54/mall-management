...
| | | | |
|---|---|---|---|
| **103** models | **153** services | **52** admin resources | **9** portal resources |
| **52** API controllers | **19** dashboard widgets | **47** console commands | **6** queued jobs |
| **35** notifications | **234** migrations | **37** module docs | **776** test files |
...
| **Tests** | 776 files — 129 scenario, 393 regression. |
