...
| | | | |
|---|---|---|---|
| **132** models | **182** services | **68** admin resources | **9** portal resources |
| **61** API controllers | **19** dashboard widgets | **66** console commands | **6** queued jobs |
| **39** notifications | **326** migrations | **39** module docs | **1369** test files |
...
| **Tests** | 1369 files — 230 scenario, 869 regression. |
