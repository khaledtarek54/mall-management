...
| | | | |
|---|---|---|---|
| **103** models | **152** services | **52** admin resources | **8** portal resources |
| **52** API controllers | **18** dashboard widgets | **47** console commands | **6** queued jobs |
| **35** notifications | **234** migrations | **37** module docs | **769** test files |
...
| **Tests** | 769 files — 129 scenario, 388 regression. |
