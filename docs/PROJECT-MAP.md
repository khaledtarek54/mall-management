...
| | | | |
|---|---|---|---|
| **116** models | **161** services | **59** admin resources | **9** portal resources |
| **54** API controllers | **19** dashboard widgets | **52** console commands | **6** queued jobs |
| **37** notifications | **258** migrations | **37** module docs | **854** test files |

### Coverage — what the gates actually enforce

| Dimension | State |
|---|---|
| **Property isolation** | 116 models classified — 86 property-owned, 29 shared, 1 self. Gated by `PropertyIsolationConformanceTest`. |
...
| **Tests** | 854 files — 144 scenario, 454 regression. |
