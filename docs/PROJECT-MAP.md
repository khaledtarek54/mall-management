...
| | | | |
|---|---|---|---|
| **101** models | **150** services | **51** admin resources | **8** portal resources |
| **52** API controllers | **17** dashboard widgets | **46** console commands | **6** queued jobs |
| **35** notifications | **231** migrations | **37** module docs | **738** test files |
...
| **Tests** | 738 files — 123 scenario, 364 regression. |
