...
| | | | |
|---|---|---|---|
| **105** models | **157** services | **52** admin resources | **9** portal resources |
| **52** API controllers | **19** dashboard widgets | **51** console commands | **6** queued jobs |
| **36** notifications | **237** migrations | **37** module docs | **817** test files |
...
| **Tests** | 817 files — 137 scenario, 425 regression. |
