...
| | | | |
|---|---|---|---|
| **130** models | **180** services | **68** admin resources | **9** portal resources |
| **61** API controllers | **19** dashboard widgets | **66** console commands | **6** queued jobs |
| **39** notifications | **325** migrations | **39** module docs | **1366** test files |

### Coverage — what the gates actually enforce

| Dimension | State |
|---|---|
| **Property isolation** | 130 models classified — 91 property-owned, 38 shared, 1 self. Gated by `PropertyIsolationConformanceTest`. |
...
| **Tests** | 1366 files — 228 scenario, 868 regression. |
