...
| | | | |
|---|---|---|---|
| **120** models | **161** services | **63** admin resources | **9** portal resources |
| **54** API controllers | **19** dashboard widgets | **52** console commands | **6** queued jobs |
| **37** notifications | **263** migrations | **37** module docs | **870** test files |
...
| **Tests** | 870 files — 149 scenario, 464 regression. |
