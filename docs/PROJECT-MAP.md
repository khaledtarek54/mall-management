...
| | | | |
|---|---|---|---|
| **83** models | **127** services | **42** admin resources | **6** portal resources |
| **39** API controllers | **17** dashboard widgets | **39** console commands | **6** queued jobs |
| **29** notifications | **175** migrations | **34** module docs | **537** test files |
...
| **Tests** | 537 files — 88 scenario, 227 regression. |
