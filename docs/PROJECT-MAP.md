...
| | | | |
|---|---|---|---|
| **81** models | **118** services | **42** admin resources | **6** portal resources |
| **39** API controllers | **17** dashboard widgets | **37** console commands | **6** queued jobs |
| **29** notifications | **165** migrations | **34** module docs | **520** test files |
...
| **Tests** | 520 files — 88 scenario, 212 regression. |
