...
| | | | |
|---|---|---|---|
| **81** models | **119** services | **42** admin resources | **6** portal resources |
| **39** API controllers | **17** dashboard widgets | **37** console commands | **6** queued jobs |
| **29** notifications | **167** migrations | **34** module docs | **523** test files |
...
| **Tests** | 523 files — 88 scenario, 215 regression. |
