...
| | | | |
|---|---|---|---|
| **88** models | **135** services | **46** admin resources | **7** portal resources |
| **47** API controllers | **17** dashboard widgets | **41** console commands | **6** queued jobs |
| **31** notifications | **188** migrations | **36** module docs | **560** test files |

### Coverage — what the gates actually enforce

| Dimension | State |
|---|---|
| **Property isolation** | 88 models classified — 70 property-owned, 17 shared, 1 self. Gated by `PropertyIsolationConformanceTest`. |
...
| **Tests** | 560 files — 89 scenario, 242 regression. |
