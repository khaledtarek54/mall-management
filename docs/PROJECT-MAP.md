...
| | | | |
|---|---|---|---|
| **87** models | **135** services | **45** admin resources | **7** portal resources |
| **47** API controllers | **17** dashboard widgets | **41** console commands | **6** queued jobs |
| **31** notifications | **185** migrations | **36** module docs | **556** test files |

### Coverage — what the gates actually enforce

| Dimension | State |
|---|---|
| **Property isolation** | 87 models classified — 70 property-owned, 16 shared, 1 self. Gated by `PropertyIsolationConformanceTest`. |
...
| **Tests** | 556 files — 88 scenario, 239 regression. |
