...
| | | | |
|---|---|---|---|
| **107** models | **158** services | **53** admin resources | **9** portal resources |
| **52** API controllers | **19** dashboard widgets | **51** console commands | **6** queued jobs |
| **36** notifications | **243** migrations | **37** module docs | **824** test files |
...
| **Tests** | 824 files — 137 scenario, 432 regression. |
