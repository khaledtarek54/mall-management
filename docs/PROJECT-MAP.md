...
| | | | |
|---|---|---|---|
| **115** models | **161** services | **58** admin resources | **9** portal resources |
| **54** API controllers | **19** dashboard widgets | **52** console commands | **6** queued jobs |
| **37** notifications | **257** migrations | **37** module docs | **852** test files |

### Coverage — what the gates actually enforce

| Dimension | State |
|---|---|
| **Property isolation** | 115 models classified — 86 property-owned, 28 shared, 1 self. Gated by `PropertyIsolationConformanceTest`. |
...
| **Tests** | 852 files — 143 scenario, 453 regression. |
