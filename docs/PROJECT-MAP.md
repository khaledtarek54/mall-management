...
| | | | |
|---|---|---|---|
| **101** models | **149** services | **51** admin resources | **8** portal resources |
| **52** API controllers | **17** dashboard widgets | **46** console commands | **6** queued jobs |
| **35** notifications | **227** migrations | **37** module docs | **723** test files |
...
| **Tests** | 723 files — 122 scenario, 352 regression. |
