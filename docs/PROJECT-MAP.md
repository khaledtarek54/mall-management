...
| | | | |
|---|---|---|---|
| **124** models | **164** services | **67** admin resources | **9** portal resources |
| **54** API controllers | **19** dashboard widgets | **54** console commands | **6** queued jobs |
| **37** notifications | **279** migrations | **38** module docs | **907** test files |
