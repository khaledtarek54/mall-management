...
| | | | |
|---|---|---|---|
| **103** models | **152** services | **52** admin resources | **9** portal resources |
| **52** API controllers | **19** dashboard widgets | **47** console commands | **6** queued jobs |
| **35** notifications | **234** migrations | **37** module docs | **775** test files |
...
| **Tests** | 775 files — 129 scenario, 392 regression. |
