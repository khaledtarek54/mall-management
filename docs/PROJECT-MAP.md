...
| | | | |
|---|---|---|---|
| **104** models | **155** services | **52** admin resources | **9** portal resources |
| **52** API controllers | **19** dashboard widgets | **47** console commands | **6** queued jobs |
| **35** notifications | **236** migrations | **37** module docs | **779** test files |
...
| **Tests** | 779 files — 129 scenario, 396 regression. |
