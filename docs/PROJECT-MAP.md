...
| | | | |
|---|---|---|---|
| **100** models | **146** services | **51** admin resources | **7** portal resources |
| **47** API controllers | **17** dashboard widgets | **45** console commands | **6** queued jobs |
| **35** notifications | **216** migrations | **37** module docs | **707** test files |
...
| **Tests** | 707 files — 120 scenario, 342 regression. |
