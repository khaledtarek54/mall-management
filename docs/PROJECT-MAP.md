...
| **37** notifications | **254** migrations | **37** module docs | **846** test files |

### Coverage — what the gates actually enforce

| Dimension | State |
|---|---|
| **Property isolation** | 114 models classified — 86 property-owned, 27 shared, 1 self. Gated by `PropertyIsolationConformanceTest`. |
...
| **Tests** | 846 files — 140 scenario, 450 regression. |
