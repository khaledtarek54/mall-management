...
| | | | |
|---|---|---|---|
| **83** models | **125** services | **42** admin resources | **6** portal resources |
| **39** API controllers | **17** dashboard widgets | **38** console commands | **6** queued jobs |
| **29** notifications | **170** migrations | **34** module docs | **529** test files |
...
| **Tests** | 529 files — 88 scenario, 221 regression. |
