...
| + | **Security deposits** (تأمينات) *(just shipped)* | Tenant deposits tracked as receipt / refund / forfeit — held as a **liability** (money you owe back), turning into income only if forfeited. | Record a deposit received, refund it, or forfeit it — and read exactly how much tenant money is still held. |
