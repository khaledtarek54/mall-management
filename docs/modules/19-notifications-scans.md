...
| `AnnouncementNotification` | database, **push** (no email) | Tenant + portal logins | SendAnnouncementAction (via BroadcastAnnouncement job) | Operator composes an announcement → broadcast to every active tenant of the target property |
