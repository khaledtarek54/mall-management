...
- **[next]** Phase 2 — close the per-module coverage gaps in §5 (thin services/commands, `PaymentLinkController`, `InvoiceIssued` mailable, per-resource authz matrix), now that factories make fixtures easy.
