...
_مصدر الحقيقة: `app/Services/GeneratePreventiveWorkOrdersService.php` و`app/Models/MaintenancePlan.php` و`app/Models/VendorContract.php` و`docs/modules/12-vendors.md` و`26-preventive-maintenance.md`._
