  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: t.whatAJobCosts, link: `${p}/operations/what-a-job-costs` },
      ],
    },
    {
      text: t.people,
...
const en = {
  ...
  whatAJobCosts: 'What a job costs',
    ...
    ar: {
      ...
      themeConfig: {
        ...
        sidebar: sidebar(ar, '/ar', [
          ...
          '/ar/leasing/deposits-in-the-books',
          '/ar/money/',
          '/ar/money/invoice-lifecycle',
          '/ar/money/credit-note-lifecycle',
          '/ar/money/the-books',
          '/ar/operations/',
          '/ar/operations/request-lifecycle',
          '/ar/operations/what-a-job-costs',
          '/ar/operations/cam-recovery',
          '/ar/operations/inventory-and-books',
          '/ar/operations/preventive-and-vendors',
          '/ar/people/',
          '/ar/people/payroll',
          '/ar/people/advances-and-custody',
          '/ar/people/vendor-bills-and-expenses',
          '/ar/accounting/',
          '/ar/accounting/the-ledger',
