...
_Source of truth: `app/Services/GeneratePreventiveWorkOrdersService.php`, `app/Models/MaintenancePlan.php`, `app/Models/VendorContract.php`, and `docs/modules/12-vendors.md`, `26-preventive-maintenance.md`._
