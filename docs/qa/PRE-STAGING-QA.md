...
> [`41_lease_options.php`](scripts/41_lease_options.php) (54/54) and
> [`42_full_month_all_shapes.php`](scripts/42_full_month_all_shapes.php) (47/47). **No new defects
...
> verified against MySQL with the scripts in [`qa/scripts/`](scripts), and left a regression test
...
7. **Do a staging dry-run of a whole month, on staging data.** This is the one recommendation that
   ...
   **What HAS been done, on synthetic data:**
   [`42_full_month_all_shapes.php`](scripts/42_full_month_all_shapes.php) builds one property with
