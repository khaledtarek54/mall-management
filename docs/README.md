...
| **[`api/`](api/MOBILE-API.md)** | The mobile API a client codes against, plus the generated [`openapi.json`](api/openapi.json) (`composer api-spec`) and the [sync brief](api/MOBILE-SYNC-2026-09-02.md) — what the app must change to match the backend, and (Part 12) the six endpoints + ~30 fields the API grew on 2026-09-02 to match the portal |
