...
| **[`qa/`](qa/README.md)** | The pre-staging harness ([PRE-STAGING-QA](qa/PRE-STAGING-QA.md) + [findings](qa/PRE-STAGING-FINDINGS.md)), the [release checklist](qa/RELEASE-CHECKLIST.md), UAT scripts, the [month-long staging soak](qa/STAGING-SOAK-2026-09.md) (calendar, acts, daily check, journal), and the runnable [`scripts/`](qa/scripts/README.md) behind `composer qa` and the soak's `soak-check.sh` |
...
| **[`api/`](api/MOBILE-API.md)** | The mobile API a client codes against, plus the generated [`openapi.json`](api/openapi.json) (`composer api-spec`) and the [sync brief](api/MOBILE-SYNC-2026-09-02.md) — the short, task-shaped copy the mobile developer works from: sync status, 18 tasks, 67 endpoints, 16 payloads |
