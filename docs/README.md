...
| **[`api/`](api/MOBILE-API.md)** | The mobile API a client codes against, plus the generated [`openapi.json`](api/openapi.json) (`composer api-spec`) and the [sync brief](api/MOBILE-SYNC-2026-09-02.md) — the short, task-shaped copy the mobile developer works from: sync status, 20 tasks, 67 endpoints, 16 payloads |
