...
return [
    'refusals' => [
        ...
        'lease_already_renewed' => 'This lease has already been renewed — open :reference and renew that one instead, or cancel it first.',
        ...
        'unit_net_area_exceeds_gross' => 'The net area (:net m²) cannot exceed the gross area (:gross m²) — the net is the part inside the demise. Correct one of the two.',
