...
return [
    ...
    'settings' => [
        ...
        'fields' => [
            ...
            'new_charges_follow_escalation_helper' => 'On: the service charge and every charge added to a lease is proposed as stepping with the rent\'s increase clause. Off (Yardi\'s default): a charge steps nothing until you say so. Either way, each charge is ruled on its own row.',
