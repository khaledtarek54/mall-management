...
return [
    ...
    'settings' => [
        ...
        'modules' => [
            ...
            'credit_notes' => 'Credit an issued invoice instead of editing it.',
            'post_dated_cheques' => 'The lodged-cheque register, its maturity board and coverage alerts.',
            'deposit_transactions' => 'Security deposits held, applied to arrears and refunded.',
            'cam' => 'Common-area cost pools, apportionment and the annual true-up.',
            'utility_meters' => 'Meter readings, tariffs and the consumption billed from them.',
            'tenant_sales' => 'Turnover declarations and the percentage rent computed from them.',
            'vendors' => 'The supplier register, contracts, certificates and scorecards.',
            'procurement' => 'Purchase requests, approval routing and goods received.',
            'recurring_expenses' => 'Costs that arrive on a calendar — taxes, levies, retainers.',
            'owner_statements' => 'Owner statement runs and the disbursements that settle them.',
            'owner_requests' => 'The board an owner raises work and questions on.',
            'bank_accounts' => 'The bank register and statement reconciliation against it.',
            'budget' => 'The annual plan each property is measured against.',
            'requests' => 'The tenant request board and its service-level clock.',
            'violations' => 'House-rule breaches, fines and the repeat-offender view.',
            'areas' => 'The zones a work order is routed by.',
            'approvals' => 'The spend-approval ladder and the queue that walks it.',
            'notes' => 'Free-text communications logged against a record.',
            ...
            'marketing' => 'Marketing budgets and the levy billed against them.',
            'announcements' => 'Mall news published to tenants.',
            'marketing_posts' => 'Offers and events published to a shopper-facing app.',
            'reports' => 'The reports hub and the analyses listed in it.',
            'activity_log' => 'Who changed what, and when.',
            'custom_fields' => 'Operator-defined fields on tenants, leases, units, vendors and properties.',
            'document_templates' => 'The standing wording on tenant-facing documents.',
        ],
        ...
        'sections' => [
            ...
            'fixed_assets_description' => 'How the register depreciates what it holds. The classes themselves — the number series, the useful life and the memo value a new asset is proposed with — are rows at Setup → Asset classes.',
            'treasury' => 'Cash box and bank',
            'treasury_description' => 'Whether an outbound payment may take a cash box or a bank account below zero. Judged on the ledger as at the payment\'s date and every day after it, per property. Off records the payment and warns you in figures; on refuses it. Both can differ per property under Property overrides.',
            ...
            'modules_locked' => "Modules are the platform owner's switch. Only a super admin can turn one on or off — the decision reaches every property and every user, so it is not a right that can be granted through a role.",
            ...
            'working_calendar_description' => 'When your people are at work. Egypt\'s weekend is Friday and Saturday, so a 24-hour promise made on a Thursday afternoon is not kept by Friday afternoon. Individual dates — public holidays, Ramadan hours — are rows under Facility → Holidays.',
        ...
        'fields' => [
            ...
            'depreciation_proration' => 'First month of an asset\'s life',
            'depreciation_proration_options' => [
                'full_month' => 'Charge the whole month, whatever the day it was acquired',
                'days' => 'Charge the days held over the month\'s days (pro-rata)',
            ],
            'depreciation_proration_help' => 'Read when a month is posted: sizes any acquisition month not yet posted, never restates a posted one.',
            'refuse_overdrawn_cash' => 'A cash box is never spent below zero',
            'refuse_overdrawn_cash_helper' => 'Off: a cash payment beyond what the box holds is recorded, with a warning. On: refused, in figures.',
            'refuse_overdrawn_bank' => 'A bank account is never paid below zero',
            'refuse_overdrawn_bank_helper' => 'Off: an overdraft is allowed — recorded, with a warning. On: refused until the receipt is in.',
            ...
            'holdover_default_rate_pct_helper' => 'What a lease is charged once it runs past its expiry, as a percentage of its last rent. Never below 100% — holding over must not cost less than renewing. A lease may still carry its own agreed figure.',
            ...
            'dunning_followup_days' => 'Chase again after',
            'dunning_followup_days_helper' => 'Days before an unpaid invoice is chased again. 0 chases once, which is the default.',
            'dunning_max_notices' => 'Most notices per invoice',
            'dunning_max_notices_helper' => 'The last one is sent as a final demand if you have written that wording. 0 removes the ceiling.',
            ...
            'lease_activation_requires_helper' => 'Nothing (a lease is executed on entry — the default); the deposit received; or the deposit received or cheques lodged to cover it. Per property.',
            ...
            'new_charges_follow_escalation' => 'New charges follow the annual increase',
            'new_charges_follow_escalation_helper' => 'On: the service charge and every charge added to a lease is proposed as stepping with the rent\'s increase clause. Off (the default): a charge steps nothing until you say so. Either way, each charge is ruled on its own row.',
            ...
            'working_days_helper' => 'The days your people are at work. Egypt\'s week is Sunday to Thursday.',
            ...
            'payroll_rates_moved' => 'Payroll rates',
            'payroll_rates_moved_helper' => 'Rates are no longer set here. Egypt raises the insurable-wage band and the contribution rates on a January cadence, and a setting cannot carry the date one came into force — so a January run generated in March used March\'s numbers. They now live under HR → Payroll rates as a dated ladder: one row per year, carrying both rates and the insurable-wage floor and ceiling. Each run computes on the rung in force for the month it is FOR, and an approved run keeps the amounts it was generated with.',
    ...
    'property_overrides' => [
        ...
        'sections' => [
            ...
            'accounting' => 'Cash box and bank',
            'accounting_description' => 'Whether a payment may take this property\'s cash box or a bank account below zero. A blank field inherits the portfolio rule; Yes refuses the payment, No records it and warns in figures.',
        ],
    ],
    ...
    'imports' => [
        ...
        'columns' => [
            ...
            'percentage_rent_calculation_type' => 'Percentage rent calculation method',
            'percentage_rent_threshold' => 'Percentage rent sales threshold',
            'percentage_rent_frequency' => 'Percentage rent breakpoint frequency',
            'escalation_rate' => 'Annual increase % (own percentage only)',
            'escalation_amount' => 'Annual increase EGP (own fixed amount only)',
    ...
    'errors' => [
        ...
        'capture_not_initiated' => 'Only an initiated payment can be captured — this one already moved.',
        'issue_invoice_not_draft' => 'Only a draft invoice can be issued — this one already left draft.',
        'issue_invoice_no_lines' => 'A draft with no lines is not a document. Add at least one line, then issue.',
        ...
        'invoice_not_sendable' => 'A draft invoice cannot be sent to a tenant — issue it first. A draft is not a document the tenant may see anywhere in the system.',
        'invoice_send_failed' => 'The invoice could not be sent. It has not been recorded as sent — try again, and check the tenant has an email address on file.',
        ...
        'charge_frequency_not_billable' => 'A :frequency row cannot be billed on this agreement — the run that invoices it understands :offered and nothing else, so the charge would sit on the schedule and never be invoiced. Load it as one of those instead.',
    ...
    'validation' => [
        ...
        'import_lease_percentage_rent_needs_rate' => 'Percentage rent applies to this lease but no rate is stated — give the row a percentage rent rate, or set the clause to 0.',
        'import_lease_percentage_rent_needs_threshold' => 'Percentage rent applies with the artificial-breakpoint method but no sales threshold is stated — give the row a threshold, or state a natural-breakpoint or tiered method.',
        ...
        'sales_exclusions_unknown_type' => 'These deduction types are not recognised and would be worth nothing: :types. Use one of the listed types, or “Other”.',
    ...
    'notifications' => [
        ...
        'cash_box_overdrawn_title' => 'Cash box overdrawn',
        'cash_box_overdrawn_body' => 'Recorded, but the cash box at :property is EGP :shortfall below zero as at :date (balance EGP :balance, this payment EGP :amount). Record the receipt that funds it.',
        'bank_overdrawn_title' => 'Bank account overdrawn',
        'bank_overdrawn_body' => 'Recorded, but :account is EGP :shortfall below zero as at :date (balance EGP :balance, this payment EGP :amount). Record the receipt that funds it, or confirm the overdraft with the bank.',
        ...
        'lease_option_closing_body' => 'The :type for :tenant (:lease, unit :unit) must be exercised by :deadline — :days days left (the window runs :earliest → :deadline). After that the right is gone.',
        ...
        'sales_locked_body_disclosure' => 'Your :period sales declaration has been reviewed and locked by the operator.',
        ...
        'sales_reminder_body_disclosure' => 'We haven\'t received your :period sales report yet. Please upload it — your lease requires monthly sales reporting.',
        ...
        'sales_locked_short_disclosure' => ':period · sales declaration locked.',
        ...
        'cam_batch_billed' => ':count allocation(s) billed',
        'cam_batch_billed_body' => ':recovered recovery invoice(s), :credited credit note(s), :fee_only fee-only.',
        'cam_batch_billed_partial' => ':billed billed, :failed could not be billed',
