...
return [
    ...
    'settings' => [
        ...
        'sections' => [
            ...
            'treasury_description' => 'Whether an outbound payment may take a cash box or a bank account below zero. Judged on the ledger as at the payment\'s date and every day after it, per property. Off (Yardi\'s default) records the payment and warns in figures; on refuses it. Both can differ per property under Property overrides.',
        ...
        'fields' => [
            ...
            'refuse_overdrawn_cash_helper' => 'Off (Yardi): a payment beyond the box is recorded and you are warned. On (SAP): refused, in figures.',
            'refuse_overdrawn_bank' => 'A bank account is never paid below zero',
            'refuse_overdrawn_bank_helper' => 'Off (Yardi — an overdraft is legitimate): recorded, you are warned. On: refused until the receipt is in.',
