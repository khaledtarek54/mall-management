...
return [
    ...
    'sections' => [
        ...
        'escalation_charges_description' => 'Each charge steps on the same anniversary by its own rule: it follows the rent\'s clause, has its own percentage or fixed amount, or stands still. The rent follows the clause above, the marketing levy follows the rent, and parking bays are priced in the rentable-items register.',
        'percentage_rent' => 'Percentage Rent',
