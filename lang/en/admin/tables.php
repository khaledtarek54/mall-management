...
return [
    ...
    'sections' => [
        ...
        'escalation_charges_description' => 'Each charge steps on the same anniversary by its own rule: it follows the rent\'s clause, has its own percentage or fixed amount, or stands still. The rent follows the clause above, the marketing levy follows the rent, and each parking bay, store or sign carries its own rule on the Parking & rentable items tab — the same rules are also set from the Charge schedule tab.',
        'rentable_items_at_creation' => 'Parking & rentable items',
        'rentable_items_at_creation_description' => 'Bays, stores and signs let with the lease — each at its own rate, from the commencement unless dated otherwise, stepping on the lease anniversary by its own rule. Anything let later is added from the Parking & rentable items tab; a draft holds none.',
        'percentage_rent' => 'Percentage Rent',
