...
return [
    ...
    'facility' => [
        ...
        'help' => [
            ...
            'execution_type' => 'Switching this clears the other side: a job is handled in-house or by a contractor, never both.',
            ...
            'est_labour_hours' => 'How long this should take, up to 9,999 hours. Compared against the hours actually booked.',
    ...
    'fixed_assets' => [
        'errors' => [
            ...
            'transfer_reason_required' => 'A transfer needs a reason — that is what the register answers "where did it go, and why" from.',
            'transfer_disposed' => 'A disposed asset cannot be transferred — it has already left the books.',
            'transfer_same_property' => 'The asset is already in that property. Pick the property it is moving to.',
            'transfer_property_not_held' => 'You can only transfer an asset to a property you hold.',
            'transfer_in_acquisition_month' => 'A transfer cannot be dated in the month the asset was acquired (:month) — date it from :from. If it was registered under the wrong property and nothing has depreciated yet, correct the property on the asset itself instead.',
            'transfer_month_already_charged' => 'Depreciation for :month is already posted where the asset is. Date the transfer from :from, so that month\'s charge stays where it was booked.',
            'transfer_month_uncharged' => 'Depreciation for :month has not been posted yet where the asset is. Post it first, so the transfer carries everything the asset has accumulated here.',
            'transfer_out_of_order' => 'This asset was last transferred on :date. A transfer cannot be dated before an earlier one.',
            'transfer_tag_taken' => ':property already has an asset tagged :tag. Re-tag that asset first — a tag is unique within a property.',
            'transferred_history_locked' => 'This asset has been transferred between properties, and the transfer carried its cost, acquisition date and opening figures into the other property\'s books. To correct them, transfer it back first, correct, then transfer again.',
            'disposed_before_transfer' => 'This asset was transferred on :date — a disposal cannot be dated before it. It is disposed of from the property it is in now.',
        ...
        'fields' => [
            ...
            'total_on_books' => 'Total on the books',
        ],
        'helpers' => [
        ...
        'actions' => ['dispose' => 'Dispose', 'post_depreciation' => 'Post this month', 'transfer' => 'Transfer to another property'],
        'transfer_directions' => ['out' => 'Out', 'in' => 'In'],
        'transfers' => 'Transfers',
        'transferred' => 'Asset transferred. Its history stays in the property it came from; depreciation follows it from this month.',
        'transferred_field_hint' => 'Locked: a transfer carried this figure into another property\'s books. Transfer back to correct it.',
        'transfer_help' => [
            'to_asset_id' => 'The property the asset moves to. Its books receive the cost and the depreciation to date.',
            'transferred_on' => 'Effective for the whole month. Cannot be dated in a month already depreciated here.',
        ],
    ...
    'procurement' => [
        ...
        'decided_by_on' => 'Decided by :user on :date',
        'notices' => [
