...
return [
    'actions' => [
        ...
        'premises_effective_from_hint' => 'The day the change takes effect. Days before it keep the old footprint and the old rent; the month is billed in two parts.',
        ...
        'change_rent_effective_from_hint' => 'The day the new rent starts billing. The old rent stays on the schedule for every day before it; a mid-month date bills that month in two parts.',
        ...
        'bill_final_period' => 'Bill the final period',
        'bill_final_period_helper' => 'Switch off to end the tenancy now and invoice the days it used later.',
        ...
        'capture_payment_confirm' => 'Capturing records this money as received: the cash posts to the general ledger and the allocated invoices count it as paid. Do this only when the bank confirms the money actually arrived.',
        'issue_invoice' => 'Issue',
        'issue_invoice_confirm' => 'Issuing finalizes the invoice and posts it to the general ledger (Dr Accounts Receivable / Cr Revenue). It can no longer be edited — corrections go through a credit note or a void.',
