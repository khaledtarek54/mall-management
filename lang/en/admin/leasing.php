...
return [
    ...
    'charge_escalation' => [
        'modes' => [
            ...
            'follows_lease_none' => 'Follows the rent\'s clause (the rent does not step)',
            'follows_lease_amount' => 'Follows the rent\'s clause (the rent steps by an amount — nothing to follow)',
            'percent' => 'Its own percentage',
            'fixed_amount' => 'Its own fixed amount',
            'none' => 'No increase',
        ],
        'follows_rate' => 'Follows the rent — +:rate% :cadence',
        'follows_index' => 'Follows the rent — the index, collared, :cadence',
        'follows_none' => 'Follows the rent — which does not step, so this charge stands still',
        'follows_amount' => 'Follows the rent — which steps by an amount, so this charge stands still',
        'own_percent' => '+:rate% :cadence',
        'own_amount' => '+EGP :amount :cadence',
        'none' => 'Stands still',
        // How often the lease's anniversary comes round — the clause's `escalation_interval_months`,
        // read by every sentence above so "a year" is never printed over a quarterly clause.
        'cadence' => [
            'months' => '{1} every month|[2,*] every :n months',
            'years' => '{1} every year|[2,*] every :n years',
        ],
