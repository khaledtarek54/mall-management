...
return [
    'helpers' => [
        ...
        'unit_status_declarable' => 'Occupancy follows this unit\'s leases. Set maintenance to take it out of service.',
        'unit_status_projected' => 'Follows this unit\'s leases and is not set by hand. End the lease to change it.',
        ...
        'unit_gross_area' => 'The chargeable area: rent per m² and area-based recoveries are measured on it.',
        'unit_net_area' => 'Inside the demise only. Informational — rent per m² and recoveries stay on the gross area.',
        'remeasure_net_area' => 'Optional. Recorded as at today, so it cannot exceed the gross in force today.',
        ...
        'commencement_redates_schedule' => 'Moving it re-dates the charge rows that start on the old date and re-projects the steps.',
        'locked_after_invoicing' => 'Locked — this lease has been invoiced, and these dates are what those invoices were billed from.',
        'locked_after_stepping' => 'Locked — a contracted rent step has already been reached, and it was counted from this date.',
        ...
        'escalation_mode' => 'Steps on the lease anniversary: with the rent, by its own % or amount, or not at all.',
        'charge_escalation_rate' => 'Between 0.01 and 100, applied each anniversary.',
