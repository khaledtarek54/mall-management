...
return [
    ...
    'reports' => [
        ...
        'every_account' => 'Every account',
        'every_account_help' => 'Each account with movement in the period: opening, entries, closing — the month-end review and the auditor\'s ledger.',
        'accounts_with_movement' => '{0} No account has movement or a balance in this period|{1} 1 account with movement or a balance|[2,*] :count accounts with movement or a balance',
        'account' => 'Account',
        'choose_account_hint' => 'Choose an account to view its statement.',
        'closing_balance' => 'Closing balance',
        'opening_balance' => 'Opening balance',
        'running_balance' => 'Balance',
        // The trial balance's three column pairs (2026-09-11). Debit/credit under each of opening,
        // movement and closing — the Egyptian ميزان المراجعة layout, Odoo's Initial/Debit/Credit/End.
        ...
        'variance' => 'Variance',
        'spread' => 'Columns',
        'spread_none' => 'This period only',
        'spread_ytd' => 'This month and year to date',
        'spread_monthly' => 'Month by month',
        'spread_period' => 'Year to date',
        'spread_total' => 'Full year',
        'spread_budget' => ':group budget',
        'spread_prior_period' => ':group prior',
        'spread_prior_year' => ':group last year',
        'spread_needs_a_month' => 'Pick a month above to read it beside the year to date.',
        'assets' => 'Assets',
        ...
        'ap_aging' => [
            'nav_label' => 'AP aging',
            'title' => 'Aged payables — by supplier',
            'subheading' => '{0} No supplier is owed anything · aged as at :as_of|{1} 1 supplier is owed :total · aged as at :as_of|[2,*] :vendors suppliers are owed :total · aged as at :as_of',
            'ties_out' => '✓ Ties out to the payables control account',
            'does_not_tie' => '⚠ Control account :gl vs open bills :bills (difference :delta) — a bill not yet posted (the ledger may still be catching up), a bill dated in the future, a duplicate posting, or money moved outside a bill\'s payments tab',
            'vendor' => 'Supplier',
            'total_owed' => 'Total owed',
            'bills' => 'Bills',
            'bill_count' => '{1} 1 bill|[2,*] :count bills',
            'oldest_days' => 'Oldest (days)',
            'last_payment' => 'Last payment',
            'never_paid' => 'Never paid',
            'open_bills' => 'Open bills',
            'empty' => 'Nothing owed — every supplier bill is settled.',
            'empty_hint' => 'Approved bills with a balance appear here, aged from their due date (or their bill date when no terms were recorded). Drafts and cancelled bills are not payables.',
        ],
    ],
    ...
    'report_hub' => [
        ...
        'descriptions' => [
            ...
            'trial_balance' => 'Every account with its opening balance, the period\'s debits and credits, and its closing balance — proving the ledger balances.',
            'general_ledger' => 'Every entry against one account — or every account with movement in the period — in date order, with a running balance. Each line opens the document behind it.',
            ...
            'ap_aging' => 'Whom we owe and how late, per supplier — every open bill split by days past its due date, checked against the payables control account.',
    ...
    'pdf' => [
        ...
        'no_charge_schedule' => 'No charge schedule has been set on this lease, so nothing will be billed under it until one is added.',
        'billed_to' => 'Billed To',
