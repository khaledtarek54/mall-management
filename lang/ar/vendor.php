...
return [
    ...
    'jobs' => [
        'brief' => [
            ...
            'where' => 'الموقع',
            'limit' => 'حد الإنفاق',
            'nte' => 'الحد الأقصى غير القابل للتجاوز',
            'nte_help' => 'أي عمل يتجاوز هذا المبلغ يحتاج عرض سعر وموافقة المشغّل قبل البدء فيه.',
            'thread' => 'الرسائل',
    ...
    'profile' => [
        'email_taken' => 'يوجد حساب مقاول آخر مسجَّل بهذا البريد الإلكتروني. استخدم بريداً آخر، أو اطلب من إدارة المول سحب صلاحية الدخول من جهة الاتصال الأخرى.',
    ],
];
