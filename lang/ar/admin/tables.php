...
return [
    ...
    'sections' => [
        ...
        'escalation_charges_description' => 'يزيد كل رسم في الذكرى السنوية نفسها بقاعدته الخاصة: يتبع بند الإيجار، أو له نسبته أو مبلغه الثابت، أو يبقى كما هو. الإيجار يتبع البند أعلاه، ورسم التسويق يتبع الإيجار، والمواقف تُسعَّر من سجل الوحدات المؤجَّرة.',
