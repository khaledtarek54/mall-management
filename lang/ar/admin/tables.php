...
return [
    ...
    'sections' => [
        ...
        'escalation_charges_description' => 'يزيد كل رسم في الذكرى السنوية نفسها بقاعدته الخاصة: يتبع بند الإيجار، أو له نسبته أو مبلغه الثابت، أو يبقى كما هو. الإيجار يتبع البند أعلاه، ورسم التسويق يتبع الإيجار، وكل موقف أو مخزن أو لافتة يحمل قاعدته الخاصة في تبويب المواقف والعناصر المؤجَّرة — والقواعد نفسها تُضبط أيضًا من تبويب جدول الرسوم.',
        'rentable_items_at_creation' => 'المواقف والعناصر المؤجَّرة',
        'rentable_items_at_creation_description' => 'المواقف والمخازن واللافتات المؤجَّرة مع العقد — كل منها بسعره، من تاريخ البدء ما لم يُحدَّد تاريخ آخر، ويزيد في الذكرى السنوية للعقد بقاعدته الخاصة. ما يُؤجَّر لاحقًا يُضاف من تبويب المواقف والعناصر المؤجَّرة، والمسودة لا تحوز شيئًا.',
