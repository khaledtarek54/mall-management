...
return [
    ...
    'statuses' => [
        ...
        'payment' => [
            ...
            'refunded' => 'مُستردة',
            'bounced' => 'مرتدّة',
            // إيصال ما كان ينبغي وجوده أصلاً — يختلف عن «مُستردة» حيث عاد المال فعلاً.
            'voided' => 'ملغاة',
        ],
        'unit' => [
            'vacant' => 'شاغرة',
    ...
    'enums' => [
        ...
        'depreciation_method' => ['straight_line' => 'القسط الثابت', 'declining_balance' => 'القسط المتناقص'],
        'payment_channel' => ['admin' => 'لوحة الإدارة', 'portal' => 'بوابة المستأجر', 'mobile_api' => 'تطبيق الجوال', 'payment_link' => 'رابط سداد'],
        'document_alert_stage' => ['expiring' => 'قارب على الانتهاء', 'expired' => 'منتهٍ'],
