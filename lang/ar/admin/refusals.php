...
return [
    'refusals' => [
        ...
        'invoice_void_has_write_off' => 'على هذه الفاتورة إعدام دين. اعكس الإعدام أولًا — فإلغاؤها فوقه يُبقي خسارة الديون المعدومة قائمة على مستند لم يعد موجودًا، ويجعل رصيد المدينين بالسالب.',
