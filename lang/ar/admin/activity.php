...
return [
    'activity' => [
        ...
        'events' => [
            ...
            'cancelled' => 'أُلغي',
            'credit_reversed' => 'عُكس تطبيق الرصيد',
            'deposit_reversed' => 'عُكس خصم التأمين',
            'reopened' => 'أُعيد فتحه',
        ],
        ...
        'descriptions' => [
            ...
            'invoice' => [
                'cancelled' => 'تم إلغاء مسودة الفاتورة',
                'voided' => 'إلغاء فاتورة',
            ...
            'accounting_period' => ['reopened' => 'أُعيد فتح الفترة المحاسبية'],
            'fiscal_year' => ['reopened' => 'أُعيد فتح السنة المالية — وعُكست قيود إقفالها'],
            'journal_entry' => ['voided' => 'أُلغي قيد اليومية'],
