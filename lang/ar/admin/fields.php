...
return [
    'fields' => [
        ...
        'fixed_asset_transfer_id' => 'التحويل',
        ...
        'tag_prefix' => 'بادئة سلسلة الترقيم',
        'default_useful_life_months' => 'العمر الإنتاجي الافتراضي',
        'default_salvage_value' => 'القيمة التذكيرية الافتراضية',
        'default_tax_pool' => 'وعاء الإهلاك الضريبي الافتراضي',
        ...
        'additional_units_locked' => 'مقفول بعد تفعيل العقد — استخدم إجراء «تغيير المساحة»، فهو يسجّل تاريخ التغيير ويعيد تسعير الإيجار منه.',
        'additional_units_locked_draft' => 'مقفل — جدول رسوم هذه المسودة يحمل بالفعل درجة زيادة إيجار، أو صفًا كتبه إجراء أو استيراد. عدّل تلك الصفوف من تبويب جدول الرسوم أولًا.',
        'additional_units_helper' => 'اختياري — وحدات إضافية يشملها هذا العقد (مثل كشك مجاور). تُحتسب جميعها كمشغولة.',
        'password' => 'كلمة المرور',
        'portal_admin' => 'يمكنه التقديم والدفع',
        ...
        'security_deposit_basis' => 'أساس احتساب التأمين',
        'security_deposit_percent' => 'التأمين كنسبة من الإيجار السنوي',
        'reserved_until' => 'الحجز ساري حتى',
        'security_deposit_received' => 'تم استلام مبلغ التأمين',
        'escalation_rate' => 'نسبة الزيادة السنوية',
        'escalation_type' => 'نوع الزيادة',
        'charge' => 'الرسم',
        'escalation_mode' => 'الزيادة السنوية',
        'escalation_figure' => 'بمقدار',
        ...
        'staff_title' => 'المسمى الوظيفي بهذا العقار',
        'staff_title_helper' => 'مثل: مدير عقار، مهندس موقع، رئيس قسم التأجير.',
        'department_member_role' => 'الدور في هذه الإدارة',
        'department_member_role_helper' => 'مثل: رئيس، منسق، عضو.',
        ...
        'cam_excluded_from_denominator' => 'شيله من مقام القسمة',
        ...
        'contacted_at' => 'الوقت',
        'total_area_sqm_helper' => 'إجمالي مساحة المبنى، شاملة المساحات المشتركة والمناطق الخدمية.',
        'leasable_area_sqm_helper' => 'الجزء القابل للتأجير فقط. تُقاس نسبة الإشغال والاستردادات المبنية على المساحة عليه.',
        'area_sqm' => 'المساحة الإجمالية (م²)',
        'net_area_sqm' => 'المساحة الصافية (م²)',
        'staff' => 'موظف',
        'is_admin' => 'يمكنه إجراء تغييرات',
        'website_url_helper' => 'اكتبه كما يظهر على بطاقتهم — وسنضيف //:https تلقائيًا.',
        'trade_name_ar_hint' => 'الاسم الذي يراه المتسوقون الناطقون بالعربية في تطبيق الزوار.',
    ],
