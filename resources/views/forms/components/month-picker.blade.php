            ...
            >
                ...
                >
                    @if ($hasDate)
                        ...
                        {{--
                            THE DAY GRID IS DELIBERATELY ABSENT.

                            This picker answers a field that means a MONTH — a rent-index reading, a
                            payroll run, a billing period — where the day was never part of the
                            answer, and where a calendar of days made the operator click the 14th and
                            then normalised it to the 1st behind their back.

                            Filament's own picker already puts a month select and a year input above
                            the grid, so this keeps exactly that header, removes the days, and makes
                            either control COMMIT: choosing August 2026 stores 2026-08-01.

                            A copy of the upstream view rather than a wrapper, because the day rows
                            are markup and no flag hides them. The Alpine component it binds to is
                            upstream's own and untouched — re-read `date-time-picker.blade.php` on a
                            Filament upgrade.
                        --}}
                    @endif
