...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        table.report th { color: #6B7280; font-size: 8pt; text-transform: uppercase; letter-spacing: .04em; padding: 4px 6px; border-bottom: 1px solid #D1D5DB; text-align: {{ $isRtl ? 'right' : 'left' }}; }
