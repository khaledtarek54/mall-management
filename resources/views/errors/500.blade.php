...
<head>
    ...
    <title>{{ __('errors.500.title') }} · Atriom</title>
    ...
    <style>
        :root {
            ...
            --border-strong: rgba(0,0,0,0.14); --accent: #D97706; --grad: rgba(217,119,6,0.06);
        }
        @media (prefers-color-scheme: dark) {
            :root {
                --bg: #09090B; --ink: #FAFAFA; --ink-muted: #A1A1AA;
                --border-strong: rgba(255,255,255,0.14); --accent: #F59E0B; --grad: rgba(245,158,11,0.10);
            }
        }
