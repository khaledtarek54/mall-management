...
<head>
    ...
    <title>Something went wrong · Atriom</title>
    <link rel="icon" type="image/svg+xml" href="{{ asset('atriom-favicon.svg') }}">
    <meta name="theme-color" content="#0F766E">
    <style>
        body { margin: 0; min-height: 100vh; background: #0F1419; background-image: radial-gradient(at 50% 0%, rgba(217, 119, 6, 0.14) 0%, transparent 60%); color: #F5F0E8; font-family: 'Inter', system-ui, sans-serif; display: flex; align-items: center; justify-content: center; -webkit-font-smoothing: antialiased; }
        .card { text-align: center; padding: 2rem; max-width: 480px; }
        .logo { display: inline-flex; margin-bottom: 1.5rem; }
        .logo img { height: 2.25rem; }
        .code { font-size: 5.5rem; font-weight: 700; color: #D97706; line-height: 1; letter-spacing: -0.03em; margin-bottom: 0.5rem; text-shadow: 0 4px 24px rgba(217, 119, 6, 0.25); }
        ...
        a { display: inline-flex; align-items: center; padding: 0.65rem 1.25rem; background: transparent; border: 1px solid rgba(15, 118, 110, 0.45); color: #F5F0E8; text-decoration: none; border-radius: 8px; font-size: 0.875rem; font-weight: 500; transition: all 0.15s ease; }
