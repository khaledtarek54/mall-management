    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->recordActions([
                ...
                // Re-measuring lived here, so the unit's own page carried Delete and nothing else.
                // It is on that page now, defined once in App\Filament\Admin\Actions\UnitActions.
            ])
            ->toolbarActions([
