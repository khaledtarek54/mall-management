    ...
    public static function all(): array
    {
        return [
            ...
            Action::make('changeRent')
                ...
                ->color('warning')
                ->visible(fn (Lease $record) => in_array($record->status, Lease::OPEN_TO_COMMERCIAL_ACTS, true) && LeaseResource::canEdit($record))
            ...
            Action::make('terminate')
                ...
                ->color('danger')
                ->visible(fn (Lease $record) => in_array($record->status, Lease::OPEN_TO_COMMERCIAL_ACTS, true) && LeaseResource::canEdit($record) && auth()->user()?->can('leases.terminate'))
            ...
            Action::make('extendTerm')
                ...
                ->color('gray')
                ->visible(fn (Lease $record): bool => in_array($record->status, Lease::OPEN_TO_COMMERCIAL_ACTS, true)
                    && LeaseResource::canEdit($record))
