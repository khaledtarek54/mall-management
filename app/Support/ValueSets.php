...
class ValueSets
{
    ...
    public const SETS = [
        ...
        'maintenance_penalties.basis' => ['flat', 'per_day', 'percent_of_value'],
        'maintenance_penalties.status' => ['pending', 'final', 'applied', 'waived'],
        'maintenance_plans.maintenance_type' => ['routine', 'fixed'],
        'maintenance_work_order_items.result' => ['pending', 'pass', 'fail'],
        'maintenance_work_order_parts.source' => ['internal', 'external'],
        'maintenance_work_order_parts.status' => ['pending', 'approved', 'rejected', 'recorded'],
        'maintenance_work_orders.execution_type' => ['internal', 'external'],
        'maintenance_work_orders.priority' => ['low', 'medium', 'high', 'urgent'],
        'maintenance_work_orders.work_order_type' => ['ppm', 'cm'],
