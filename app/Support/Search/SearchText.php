...
class SearchText
{
    ...
    private const ARABIC_FOLD = [
        ...
        // ---- Arabic-Indic digits → ASCII, both ranges. An invoice number shown
        //      as ٢٠٢٦ must be findable by typing 2026 and vice versa.
        //
        //      Read from App\Support\LatinNumerals rather than written out here: the
        //      system WRITES Latin digits and READS both, and that one map is what
        //      says so. Its other reader, SalesExclusions::amount(), had its own copy
        //      covering only the basic range — so this fold and that one disagreed
        //      about a Persian digit, and the disagreement was worth money.
        //
        //      Byte-identical to the twenty entries this replaced: a change here
        //      rewrites every stored blob and needs `atriom:rebuild-search`.
        ...LatinNumerals::DIGITS,
    ];
