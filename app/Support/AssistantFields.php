...
final class AssistantFields
{
    ...
    public const NOT_SUMMARISED = [
        ...
        LedgerAccount::class => 'A chart row. Asking for one by code or name is a legitimate question and still answers with the account — but a SUMMARY of it would be its code, name and type, which is the whole row and tells the reader nothing they did not just type. The figure anybody actually wants is a balance or a movement, and that is the trial balance and the general ledger, which carry the period and the property the summary would have to invent.',
