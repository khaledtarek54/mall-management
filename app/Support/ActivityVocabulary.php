...
class ActivityVocabulary
{
    ...
    private const VALUE_VOCABULARY = [
        ...
        'deposit_transaction.method' => 'admin.enums.method',
        ...
        'maintenance_work_order.category' => 'admin.enums.maintenance_category',
        'maintenance_work_order.priority' => 'admin.enums.maintenance_priority',
        ...
        'sla_policy.priority' => 'admin.enums.maintenance_priority',
        ...
        'tenant_request.priority' => 'admin.enums.maintenance_priority',
