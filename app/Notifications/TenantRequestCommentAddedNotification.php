...
class TenantRequestCommentAddedNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(__('admin.notifications.request_comment_subject', [
            ...
            ->line(__('admin.notifications.request_comment_body', [
    ...
    public function toDatabase(object $notifiable): array
    {
        ...
        if (! $notifiable instanceof Tenant) {
            return [
                ...
                'reference' => $this->request->reference,
                'title' => __('admin.notifications.request_comment_staff_title'),
                'body' => __('admin.notifications.request_comment_staff_body', [
        ...
        return [
            ...
            'request_id' => $this->request->id,
            'reference' => $this->request->reference,
            'title' => __('admin.notifications.request_comment_title', [
                'type' => $this->request->typeLabel(),
                'reference' => $this->request->reference,
            ]),
            'body' => __('admin.notifications.request_comment_short', [
                'title' => $this->request->title,
            ]),
            'icon' => 'heroicon-o-chat-bubble-left-right',
            'color' => 'primary',
