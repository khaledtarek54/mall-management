...
- **A `DomainException` is a refusal, not a fault** — it renders as a message + redirect-back (`bootstrap/app.php`), never the 500 page. Throw it for anything the operator did that isn't allowed.
